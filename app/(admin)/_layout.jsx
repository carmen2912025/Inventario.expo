...
export default function AdminTabLayout() {
  ...
  return (
    <Tabs
      ...
      <Tabs.Screen name="indexAdmin" options={{ title: 'Productos', tabBarIcon: ({ color }) => <TabBarIcon name="archive" color={color} /> }} />
      ...
      <Tabs.Screen name="stockAdmin" options={{ title: 'Stock', tabBarIcon: ({ color }) => <TabBarIcon name="database" color={color} /> }} />
